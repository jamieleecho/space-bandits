...
- (void)testParsesFiles {
    ...
    XCTAssertEqualObjects(_infos[0].backgroundColor, [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:1.0f]);
    XCTAssertEqualObjects(_infos[0].foregroundColor, [UIColor colorWithRed:0x1b/255.0f green:0xb4/255.0f blue:0x3a/255.0f alpha:1.0f]);
    XCTAssertEqualObjects(_infos[0].progressColor, [UIColor colorWithRed:0x1b/255.0f green:0xb4/255.0f blue:0x3a/255.0f alpha:1.0f]);
    
    XCTAssertEqualObjects(_infos[1].backgroundColor, [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:1.0f]);
    XCTAssertEqualObjects(_infos[1].foregroundColor, [UIColor colorWithRed:0.0f green:0.0f blue:0.0f alpha:1.0f]);
    XCTAssertEqualObjects(_infos[1].progressColor, [UIColor colorWithRed:0x67/255.0f green:0xfb/255.0f blue:0x79/255.0f alpha:1.0f]);
}
