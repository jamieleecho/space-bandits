...
- (void)testAddsMethodsFromFile {
    XCTAssertEqual(1,  DSObjectClassDataRegistryRegisterClassData(init1, 3, reactivate1, update1, 128, "32-hello.c"));
    XCTAssertEqual(1, DSObjectClassDataRegistryRegisterClassData(init2, 4, reactivate2, update2, 64, "09-goodbyehello.c"));
...
- (void)testThrowsIfBogusFile {
    XCTAssertThrows(DSObjectClassDataRegistryRegisterClassData(init1, 2, reactivate1, update1, 64, "xx-hello.c"));
    XCTAssertThrows(DSObjectClassDataRegistryRegisterClassData(init1, 0, reactivate1, update1, 64, "20-hello.cpp"));
    XCTAssertThrows(DSObjectClassDataRegistryRegisterClassData(init1, 1, reactivate1, update1, 64, "-1-hello.cpp"));
}
